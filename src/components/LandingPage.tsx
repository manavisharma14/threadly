    ...
    <div className={styles.root}>
      ...
      {/* <nav className={styles.nav}>
        ...
        <div className={styles.navLinks}>
          ...
          <a href="#" className={styles.navCta} onClick={(e) => { e.preventDefault(); signIn(); }}>
            Sign in
          </a>
        </div>
      </nav> */}
      ...
      <section className={styles.hero}>
        ...
        {/* Hero visual — honest UI preview, no fake posts */}
          ...
          <div className={styles.mockPost} style={{ borderLeft: "3px solid #c4613a" }}>
            ...
            <div className={styles.mockActions}>
              <button
                ...
                style={{ background: "#1a1a2e", color: "#faf8f4", fontWeight: 500 }}
                onClick={() => signIn()}
              >
                Post thread →
              </button>
        ...
        <div className={styles.featuresGrid}>
          <div className={styles.featureCard}>
            ...
            <div className={styles.featureDesc}>
              See posts from people you follow, not an algorithm. ThreadO keeps
              your feed personal, relevant, and human.
            </div>
          </div>
          <div className={`${styles.featureCard} ${styles.featureCardDark}`}>
            ...
            <div className={styles.featureDesc}>
              Grow a network that actually matters. Discover people who share
              your passions and spark real dialogue.
            </div>
          </div>
          <div className={styles.featureCard}>
            ...
            <div className={styles.featureDesc}>
              No noise. No distractions. Just a beautiful editor that lets your
      ...
      <section id="belief" className={styles.testimonials}>
        <div className={styles.sectionLabel} style={{ marginTop: "5rem" }}>
          Our belief
        </div>
        ...
        <div className={styles.testimonialsRow}>
          <div className={styles.testimonial}>
            <div className={styles.tq}>
              &ldquo;Social media should feel like a conversation at a good
              dinner table — thoughtful, energizing, and worth your time.&rdquo;
            </div>
          ...
          <div className={`${styles.testimonial} ${styles.testimonialDark}`}>
            <div className={styles.tq}>
              &ldquo;We&rsquo;re building ThreadO because we wanted a place to
              share ideas without the noise. We think you deserve that too.&rdquo;
            </div>
          ...
          <div className={styles.testimonial}>
            <div className={styles.tq}>
              &ldquo;No ads. No algorithm pushing outrage. Just people sharing
              things they actually care about — and finding others who do
              too.&rdquo;
            </div>
            <div className={styles.ta}>
      ...
      <section className={styles.ctaStrip}>
        <div className={styles.ctaInner}>
          <h2>
            Be part of something <em>from day one.</em>
          </h2>
